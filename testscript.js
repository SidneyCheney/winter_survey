...
function Questions() {
    ...
    if (current_question == "question_submit") {
        document.getElementById("question_text").innerHTML = '<h1 class="col-auto mt-5 mb-5 click_selector text_decoration" id="question_text"><a onclick="SubmitSurvey()" href=”mailto:20016461@hartlandschools.us">Submit Survey</a></h1>';
    }
}
function SetScore() {
